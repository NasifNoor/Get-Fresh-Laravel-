      ...
      <div class="header-inner">
        ...
        <div class="col-sm-4 col-xs-12 header-middle">
          <div class="header-middle-top">
            <div id="logo"> <h1>Get Fresh</h1> </div>
          </div>
        </div>
    ...
    <div class="nav-inner container">
      ...
      <div class="navbar-collapse">
        <ul class="main-navigation">
          ...
          <li><a href="/customerRegistration" class="active parent">Registration</a></li>
          <li><a href="/customerLogin" class="active parent">Login</a></li>
        </ul>
      </div>
    </div>
  </nav>
